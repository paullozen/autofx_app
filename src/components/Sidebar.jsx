...
import { User, Radio, Eraser, FileText, MessageSquare, Image, Palette, Film, Moon, Sun, LogIn, AudioWaveform, Download } from 'lucide-react';
            ...
            <div className="flex-1 overflow-y-auto py-4">
                <div className="px-4 mb-6">
                    ...
                    <div className="space-y-1">
                        {configStages.map(renderStageItem)}
                    </div>
                </div>
                ...
                <div className="px-4 mb-6">
                    ...
                    <div className="space-y-1">
                        {pipelineStages.map(renderStageItem)}
                    </div>
                </div>
                ...
                <div className="px-4">
                    ...
                    <div className="space-y-1">
                        {utilityStages.map(renderStageItem)}
                    </div>
                </div>
            </div>
        </div>
